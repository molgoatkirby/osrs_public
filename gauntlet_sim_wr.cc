...
int main() {
	...
	int punch = 4;
	if (corrupt) punch = 4; // 5 is for armour, but we doing naked wr
	...
	*/
	...
	try {
		...
		if (corrupt) {
			subText1 = "Sub 2:30 Chance,";
			subText2 = "Sub 2:45 Chance,";
			subText3 = "Sub 3:00 Chance,";
			subTick1 = 250; subTick2 = 275; subTick3 = 300;
		}
		...
		for (int x = lowerTickLimit; x <= upperTickLimit; x += 10) {
			for (int y = 0; y < loops; y++) {
				if (staff3bow3[foodTest][y] < x) survivalRate++;
			}
			survivalRate = 100*survivalRate/loops;
			resultFile << survivalRate << ",";
			survivalRate = 0;
		...
		for (int x = lowerTickLimit; x <= upperTickLimit; x += 10) {
			for (int y = 0; y < loops; y++) {
				if (hally3staff2[foodTest][y] < x) survivalRate++;
			}
			survivalRate = 100*survivalRate/loops;
			resultFile << survivalRate << ",";
			survivalRate = 0;
		...
		for (int x = lowerTickLimit; x <= upperTickLimit; x += 10) {
			for (int y = 0; y < loops; y++) {
				if (staff3bow2[foodTest][y] < x) survivalRate++;
			}
			survivalRate = 100*survivalRate/loops;
			resultFile << survivalRate << ",";
			survivalRate = 0;
		...
		for (int x = lowerTickLimit; x <= upperTickLimit; x += 10) {
			for (int y = 0; y < loops; y++) {
				if (staff3bow1[foodTest][y] < x) survivalRate++;
			}
			survivalRate = 100*survivalRate/loops;
			resultFile << survivalRate << ",";
			survivalRate = 0;
		...
		for (int x = lowerTickLimit; x <= upperTickLimit; x += 10) {
			for (int y = 0; y < loops; y++) {
				if (bow3staff2[foodTest][y] < x) survivalRate++;
			}
			survivalRate = 100*survivalRate/loops;
			resultFile << survivalRate << ",";
			survivalRate = 0;
		...
		for (int x = lowerTickLimit; x <= upperTickLimit; x += 10) {
			for (int y = 0; y < loops; y++) {
				if (bow3staff1[foodTest][y] < x) survivalRate++;
			}
			survivalRate = 100*survivalRate/loops;
			resultFile << survivalRate << ",";
			survivalRate = 0;
